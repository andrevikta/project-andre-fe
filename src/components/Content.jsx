    ...
    const fetchData = async () => {
      try {
        ...
        if (currentUserResponse.data.user.id) {
          const dataTransaction = await axios.get(`https://project-andre.herokuapp.com/transactions/seller/${currentUserResponse.data.user.id}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (currentUserResponse.data.user.id) {
          const dataTransaction = await axios.get(`https://project-andre.herokuapp.com/transactions/user/${currentUserResponse.data.user.id}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
...
export function UserProfile() {
  ...
  const onUpdateById = async (e, isPublish) => {
    ...
    try {
      ...
      const createRequest = await axios.put(`https://project-andre.herokuapp.com/products/${id}`, postPayload, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const onCreateTransaction = async (e, isOpened, isRejected, isAccepted) => {
    ...
    try {
      ...
      setShow(false);
      const createRequest = await axios.post("https://project-andre.herokuapp.com/transactions", postPayload, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      const responseTransactionByUserId = await axios.get(`https://project-andre.herokuapp.com/transactions/user/${userId.id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
